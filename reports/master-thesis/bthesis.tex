...
The parameter $k$ fixes the topology of the universe. In this thesis we use $k = 0$ i.e. a flat universe as suggested by data of e.g. the Planck mission ?????.
...
\end{equation}
These integrals can be evaluated in the relativistic limit where $T \ll m$:
\begin{equation}
	\rho = \begin{cases} 
...
These equations togher with the Friedmann equation, describe the background cosmology for our later computations.
