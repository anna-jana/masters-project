...
Then we check how large the relative change in the $B - L$ charge over this interval is. If its below $10^{-3}$  we stop the iterations. Otherwise we proceed to integrate about 10 unit of time in axion units. This allows us to obtain results within at least 3 digits of significance as is required to be compared to the observed value.
