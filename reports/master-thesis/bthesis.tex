...
\subsection{Dynamics}
TODO vielleicht umschreiben sodass alle formeln zu einer epche zusammen sind und nicht alle formeln eines typs zusammen sind??????
...
To do this, we will approximate the wavefunction $Z(\theta)$ such that it is easier to handle: \\
For $\theta \simeq O(1) \to \pi$ we find that
\begin{equation}
...
\end{equation}
From these approximations to the potential, we can derive the dynamics. 
