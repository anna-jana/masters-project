...
Since the transition between different vacuum states corresponds to a change in baryon and lepton number, eq. \eqref{eq:rates} gives the rate of conversion between them.
