...
\end{equation}
A natural step for a theory with many fields like this is to take the continuum limit and replace the field index with a coordinate $y$ of an extra-dimension.
...
We now want to find a canonically normalized field 
\begin{equation}
