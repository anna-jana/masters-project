...
Let us investigate these conditions in the known physics of the standard model (SM).
In the standard model, the baryon and the lepton numbers are violated by the follwing nonperturbutive term:
\begin{equation}
