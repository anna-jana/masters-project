...
\end{equation}
In order to evaluated these expectation values we have to use a trick.
We want to find a density matrix such that the expectation value with it vanishes for the charges $Q_i$:
\begin{equation}
