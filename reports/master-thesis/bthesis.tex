...
\subsection{Quantum Linear Response Theory}
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l}
			...
			SU(2) feinstructure constant $\alpha_2 \approx $ \\
			SU(3) feinstructure constant $\alpha_3 \approx $ \\
			lepton Yukawa coupling $y_{l^f} \approx $ \\
			up-type quark Yukawa coupling $y_{u^f} \approx $ \\
			down-type quark Yukawa coupling $y_{d^f} \approx $ \\ 
		\end{tabular}
	\end{center}
\end{table}
