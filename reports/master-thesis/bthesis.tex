...
Furthermore we analyze the dependence of the asymmetry on the Hubble value at the end of inflation $H_\mathrm{inf}$ and the initial misalignment angle $\theta_i$. 
TODO TODO
