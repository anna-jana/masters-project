...
%% folgenden Zeilen geloescht werden
  \bigskip\par
  \textbf{Stichwörter:} Physik, Masterarbeit, Kosmologie, Axions, Baryogenese, Dynamik
\end{abstract}
...
\begin{abstract}
  ...
  half a page.
  \bigskip\par
  \textbf{Keywords:} Physics, Masters thesis, Cosmology, Axions, Baryogenesis, Dynamics
\end{abstract}
