...
$\left| \frac{V''}{c H^2} \right| \ll 1 $ holds.
The Hubble parameter at which this condition is saturated is called $H_\mathrm{osc}$.
...
First the field is frozen due to Hubble friction. For this one can use the approximation found in sec. \ref{sec:slow_roll_approximation}. One can even approximate it as $\phi = \phi(t_\mathrm{init})$.
Once the condition in eq. 
