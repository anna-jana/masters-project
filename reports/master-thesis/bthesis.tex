...
\section{Derivation of Transport Equation}
...
\begin{table}[H]
	...
	\title{Charges of the Standard Model}
	\begin{center}
		\begin{tabular}{lll}
			...
			\end{pmatrix}$ & \\
			\hline
			right-handed first lepton generation (electron) singlet & $R_1 = R_e$ & \\
			right-handed second lepton generation (muon) singlet & $R_2 = R_\mu$ & \\
			right-handed third lepton generation (tau) singlet & $R_3 = R_\tau$ & \\
			\hline \hline
		    ...
		    \end{pmatrix} $ & \\
	    	\hline
	    	right-handed first generation up-type quark (up) & $u_R$ & \\
	    	right-handed second generation up-type quark (charm) & $c_R$ & \\
	    	right-handed third generation up-type quark (top) & $t_R$ & \\
	    	right-handed first generation down-type quark (down) & $d_R$ & \\
	    	right-handed second generation down-type quark (strange) & $s_R$ & \\
	    	right-handed third generation down-type quark (bottom) & $b_R$ & \\
	    	\hline \hline
...
\begin{table}[H]
	...
	\title{Interactions in the Standard Model}
	\begin{center}
		\begin{tabular}{llll}
			Name & Symbol & Rate & Equilibration Temperature \\
			\hline 
		\end{tabular}
	\end{center}
\end{table}
