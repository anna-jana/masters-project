...
In order for the field to maintain a tracking solution this condition needs to be invariant under the time-evolution. Hence if the take the derivative of the equation of motion (in the form of eq. \eqref{eq:tracking_eom}) with respect to the field $\phi$ while also assuming a constant $x$ (eq. \eqref{eq:const_x}) we obtain a necessary condition for a stable tracking solution:
\begin{align}
...
Furthermore it is also necessary that the solution is stable under small perturbations of $w_\phi$.
