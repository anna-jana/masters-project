...
\end{align}
Therefore C and CP violation is required for baryogenesis. The violation of C and CP symmetry can also be discussed more on the level of the B violating processes. A detailed discussion can be found in \cite[sec 2.3]{Cline:2006ts_Baryogenesis}. % as well as %\cite[sec. 6.3]{the_early_universe_kolb_and_turner}.
